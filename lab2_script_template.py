def main():
    ...
    about_me = {"full_name": "Charanjeet kaur",
                "student_id": 10323322,
                "pizza_toppings": ["MASHROOMS","CAPSICUM","PINEAPPLE"],
                'movies': [
                    {"title": "The Twilight Saga Eclipse","genere": "Romantic"},
                    {"title": "Shaitaan","genere": "Horror"}]
                }

    # TODO: Step 3 - Add another movie to the data structure
    about_me["movies"].append({"title": "The BrickLayer", "genere": "Action"})
    ...
    add_pizza_toppings(about_me, ("Simply Cheese", "Black Olives"))
